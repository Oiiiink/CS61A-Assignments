    ...
    def check_eights(num) :
        if num < 100 : 
            ...
            if num % 100 == 88 :
                ...
                return check_eights(num // 10)
    return check_eights(n)
    ...
    def can_reach(x , y , limits) :
        if limits == 0 :
            ...
            if f(x) == y or g(x) == y :
                ...
                return can_reach(f(x) , y , limits - 1) or can_reach(g(x) , y , limits - 1)
    return can_reach
